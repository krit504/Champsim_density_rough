...
void print_dram_stats()
{
    ...
    cout << " DRAM RQ MERGED: " <<uncore.DRAM.RQ[i].MERGED<< endl;
        cout << endl;
    }
...
int main(int argc, char** argv)
{
	...
	ooo_cpu[i].L1I.l1i_prefetcher_cache_fill = cpu_l1i_prefetcher_cache_fill;
        ...
        ooo_cpu[i].L2C.l2c_prefetcher_initialize();           // Modified by Prathamesh
    ...
    ooo_cpu[0].L2C.l2c_initialize_replacement();   
...
#ifndef CRC2_COMPILE
    //for (uint32_t i=0; i<NUM_CPUS; i++)                                     // Modified by Prathamesh
    //{    
