...
outfiles[1]="$OUTDIR/results_dynamic_4core_v2all.txt"
outfiles[2]="$OUTDIR/results_dynamic_4core_v3all.txt"
outfiles[3]="$OUTDIR/results_dynamic_4core_v4all.txt"
outfiles[4]="$OUTDIR/results_dynamic_4core_v4bc12.txt"

for i in 1 2 3 4; do
    echo "========================================" > ${outfiles[$i]}
    echo "4-CORE DYNAMIC | ${labels[$i]} | warmup=10M sim=250M" >> ${outfiles[$i]}
    echo "========================================" >> ${outfiles[$i]}
    ...
    echo "[$(date)] Done run $i/4: ${labels[$i]}"
done
